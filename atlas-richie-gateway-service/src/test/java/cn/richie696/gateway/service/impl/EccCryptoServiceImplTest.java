...
class EccCryptoServiceImplTest {
    ...
    @Mock
    private cn.richie696.component.cache.ops.ValueOps valueOps;

    @Mock
    private cn.richie696.component.cache.ops.StructOps structOps;

    @Mock
    private cn.richie696.component.cache.ops.KeyOps keyOps;
