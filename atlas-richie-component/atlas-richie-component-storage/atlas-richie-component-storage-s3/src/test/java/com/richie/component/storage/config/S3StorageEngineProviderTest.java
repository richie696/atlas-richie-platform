...
class S3StorageEngineProviderTest {

    private final S3StorageEngineProvider provider = new S3StorageEngineProvider();

    @Test
    void supportedEngineType_shouldReturnAwsS3() {
        assertThat(provider.supportedEngineType()).isEqualTo(StorageEngineEnum.AWS_S3);
    }
    ...
    private StorageProperties validProperties() {
        StorageProperties properties = new StorageProperties();
        properties.getObject().setEndpoint("s3.us-east-1.amazonaws.com");
