...
@Slf4j
@Configuration
@ComponentScan("cn.richie696.component.storage")
...
public class OssAutoConfiguration {
    ...
    /**
     * OSS 存储引擎 Provider（手动模式 + 自动模式均注册）
     */
    @Bean
    public StorageEngineProvider ossStorageEngineProvider() {
        return new OssStorageEngineProvider();
    }
