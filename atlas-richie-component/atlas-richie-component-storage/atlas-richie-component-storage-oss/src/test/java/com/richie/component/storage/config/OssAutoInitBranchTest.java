...
class OssAutoInitBranchTest {

    @Test
    void shouldHaveConfigurationAnnotation() {
        assertThat(OssAutoConfiguration.class.getAnnotation(Configuration.class)).isNotNull();
    }

    @Test
    void providerBeanMethod_shouldBeAnnotatedWithBean() throws NoSuchMethodException {
        Method method = OssAutoConfiguration.class.getMethod("ossStorageEngineProvider");
    ...
    @Test
    void clientBeanMethod_shouldBeConditionalOnEngineAliyunOss() throws NoSuchMethodException {
        Method method = OssAutoConfiguration.class.getMethod("ossClient", StorageProperties.class);
        var conditions = Arrays.stream(method.getAnnotationsByType(ConditionalOnProperty.class))
                ...
                .filter(c -> "aliyun_oss".equals(c.havingValue()))
                .findFirst();
