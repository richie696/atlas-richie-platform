...
class OssStorageEngineProviderTest {

    private final OssStorageEngineProvider provider = new OssStorageEngineProvider();

    @Test
    void supportedEngineType_shouldReturnAliyunOss() {
        assertThat(provider.supportedEngineType()).isEqualTo(StorageEngineEnum.ALIYUN_OSS);
    }
    ...
    private StorageProperties validProperties() {
        StorageProperties properties = new StorageProperties();
        properties.getObject().setEndpoint("oss-cn-hangzhou.aliyuncs.com");
