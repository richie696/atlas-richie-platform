...
class Ks3StorageTypeConverterTest {

    private final Ks3StorageTypeConverter converter = new Ks3StorageTypeConverter();
    ...
    void convert_unsupportedType_throws() {
        assertThatThrownBy(() -> converter.convertToEngineType(StorageTypeEnum.DEEP_COLD_ARCHIVE))
