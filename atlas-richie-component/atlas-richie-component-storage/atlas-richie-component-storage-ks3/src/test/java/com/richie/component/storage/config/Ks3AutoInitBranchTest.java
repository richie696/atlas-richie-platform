...
class Ks3AutoInitBranchTest {

    @Test
    void shouldHaveConfigurationAnnotation() {
        assertThat(Ks3AutoConfiguration.class.getAnnotation(Configuration.class)).isNotNull();
    }

    @Test
    void providerBeanMethod_shouldBeAnnotatedWithBean() throws NoSuchMethodException {
        Method method = Ks3AutoConfiguration.class.getMethod("ks3StorageEngineProvider");
    ...
    @Test
    void clientBeanMethod_shouldBeConditionalOnEngineKsyunKs3() throws NoSuchMethodException {
        Method method = Ks3AutoConfiguration.class.getMethod("ks3Client", StorageProperties.class);
        var conditions = Arrays.stream(method.getAnnotationsByType(ConditionalOnProperty.class))
                ...
                .filter(c -> "ksyun_ks3".equals(c.havingValue()))
                .findFirst();
