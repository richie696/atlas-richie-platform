 ...
 * @author richie696
 * @version 1.0
 * @see <a href="https://docs.ksyun.com/documents/41397?type=3">金山云 KS3 管理文件访问权限（Java）</a>
 * @since 2025-01-XX
 */
@Component
@ConditionalOnProperty(prefix = "platform.component.storage.object", name = "engine", havingValue = "ksyun_ks3")
public class Ks3AclTypeConverter implements AclTypeConverter<CannedAccessControlList> {
