...
class TosAutoInitBranchTest {

    @Test
    void shouldHaveConfigurationAnnotation() {
        assertThat(TosAutoConfiguration.class.getAnnotation(Configuration.class)).isNotNull();
    }

    @Test
    void providerBeanMethod_shouldBeAnnotatedWithBean() throws NoSuchMethodException {
        Method method = TosAutoConfiguration.class.getMethod("tosStorageEngineProvider");
    ...
    @Test
    void clientBeanMethod_shouldBeConditionalOnEngineVolcengineTos() throws NoSuchMethodException {
        Method method = TosAutoConfiguration.class.getMethod("tosClient", StorageProperties.class);
        var conditions = Arrays.stream(method.getAnnotationsByType(ConditionalOnProperty.class))
                ...
                .filter(c -> "volcengine_tos".equals(c.havingValue()))
                .findFirst();
