 ...
 * <p>
 * 原先 {@link com.richie.component.storage.config.StorageEngineProxyFactoryBean} 与
 * {@link com.richie.component.storage.config.StorageEngineRegistry.ProxyHolder}
...
public final class StorageEngineInvocationHandler implements InvocationHandler {
    ...
    /**
     * 为指定引擎类型创建 handler（{@link com.richie.component.storage.config.StorageEngineRegistry} 使用）
     */
    ...
    /**
     * 创建未指定类型的 handler（{@link com.richie.component.storage.config.StorageEngineProxyFactoryBean} 与对象存储统一代理使用）
     */
