...
import cn.richie696.component.storage.config.StorageEngineAutoConfiguration;
...
class StorageEngineAutoConfigurationAuditTest {
    ...
    @Configuration
    @EnableConfigurationProperties(cn.richie696.component.storage.config.StorageProperties.class)
