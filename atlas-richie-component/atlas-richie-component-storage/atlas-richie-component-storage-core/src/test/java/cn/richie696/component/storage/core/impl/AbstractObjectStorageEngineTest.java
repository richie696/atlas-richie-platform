...
class AbstractObjectStorageEngineTest {
    ...
    void getAcl_withWorkingConverter_returnsValue() {
        var aclConverter = new cn.richie696.component.storage.converter.AclTypeConverter<String>() {
            @Override
    ...
    private static final class TestEngine extends AbstractObjectStorageEngine<Object> {
        ...
        public cn.richie696.component.storage.bean.UploadResponse putObject(@NonNull String key, java.io.@NonNull InputStream inputStream) {
            return cn.richie696.component.storage.bean.UploadResponse.builder()
