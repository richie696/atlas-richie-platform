...
class AzureBlobAutoInitBranchTest {

    @Test
    void shouldHaveConfigurationAnnotation() {
        assertThat(AzureBlobAutoConfiguration.class.getAnnotation(Configuration.class)).isNotNull();
    }

    @Test
    void providerBeanMethod_shouldBeAnnotatedWithBean() throws NoSuchMethodException {
        Method method = AzureBlobAutoConfiguration.class.getMethod("azureBlobStorageEngineProvider");
    ...
    @Test
    void clientBeanMethod_shouldBeConditionalOnEngineAzureBlob() throws NoSuchMethodException {
        Method method = AzureBlobAutoConfiguration.class.getMethod("blobContainerClient", StorageProperties.class);
        var conditions = Arrays.stream(method.getAnnotationsByType(ConditionalOnProperty.class))
                ...
                .filter(c -> "azure_blob".equals(c.havingValue()))
                .findFirst();
