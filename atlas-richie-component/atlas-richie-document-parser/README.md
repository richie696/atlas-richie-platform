# Atlas Richie Document Parser Component (atlas-richie-document-parser)
...
`atlas-richie-document-parser` is the unified document-parsing component of the Atlas Richie platform. It
