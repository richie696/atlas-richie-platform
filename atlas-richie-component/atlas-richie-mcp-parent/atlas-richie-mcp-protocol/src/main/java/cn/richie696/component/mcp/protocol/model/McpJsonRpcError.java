 ...
 *
 * 为什么独立建模：JSON-RPC 2.0 规定响应 {@code error} 是三字段对象（{@code code}、
 * {@code message}、{@code data}），但很多业务侧在处理时直接用 {@link cn.richie696.component.mcp.protocol.McpProtocolException}
