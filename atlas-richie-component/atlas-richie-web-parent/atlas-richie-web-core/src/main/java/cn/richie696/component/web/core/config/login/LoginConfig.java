 ...
 */
package cn.richie696.component.web.core.config.login;
 ...
 * <p>
 * 由 {@link cn.richie696.component.web.core.adapter.IssueTokenAdvice} 消费：
 * <ul>
 ...
 *
 * <h2>与 Web 主配置的关系</h2>
 * <p>本类绑定 {@code platform.component.web.login}，作为 {@link cn.richie696.component.web.core.config.WebProperties}
 ...
 * {@link cn.richie696.component.web.core.adapter.IssueTokenAdvice} 整个被旁路
 * （参见其 javadoc &lt;作用域&gt; 段落）。
