 ...
 */
package cn.richie696.component.web.core.metrics;

import cn.richie696.component.web.core.sse.SseManager;
 ...
 * 配合 {@code atlas-richie-concurrency} 的 {@code <optional>true</optional>} 声明，
...
public final class WebMetrics {
     ...
     * <p>拦截器层无法自动包 controller 方法（{@link cn.richie696.component.web.core.spi.WebInterceptorChain#proceed}
