# Atlas Richie Statemachine Component (atlas-richie-statemachine)
...
| Item                  | Value                                                                                    |
|-----------------------|------------------------------------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-statemachine`                             |
| **Category**          | Domain logic — state machine                                                             |
| **Hard dependencies** | `easy-rules` 4.1.0, `atlas-richie-cache` (Redis), `atlas-richie-dao` |
