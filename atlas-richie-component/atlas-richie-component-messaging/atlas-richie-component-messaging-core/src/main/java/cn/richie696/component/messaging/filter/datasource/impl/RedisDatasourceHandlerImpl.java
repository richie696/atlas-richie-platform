 ...
 */
package cn.richie696.component.messaging.filter.datasource.impl;
 ...
 * <p>
 * 工作原理：
 * 1. 使用 {@link cn.richie696.component.cache.ops.ValueOps#setIfAbsent(String, String, long) GlobalCache.value().setIfAbsent} 方法（基于 Redis SET NX）
...
public class RedisDatasourceHandlerImpl implements DatasourceHandler {
     ...
     * <p>
     * 实现原理：
     * - 使用 {@link cn.richie696.component.cache.ops.ValueOps#setIfAbsent(String, String, long) GlobalCache.value().setIfAbsent} 方法
