 ...
 * 大语言模型（LLM）调用服务接口。
 * <p>
 * 提供统一的 LLM 调用能力，支持多模型动态切换；多模态能力（语音 / 图像 / Rerank 等）
 * 请使用 {@code AiMultimodalService}，本接口专注于大语言模型的同步、异步、流式调用与治理。
 *
 * @author richie696
 * @version 1.0
 * @since 2025-06-30
 * @see com.richie.component.ai.service.AiMultimodalService 多模态能力
 */
