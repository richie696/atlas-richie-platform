...
@Import({
        cn.richie696.component.vector.config.QdrantVectorAutoConfiguration.class,
})
...
public class VectorIntegrationTestConfiguration {
     ...
     * 固定 4 维向量 stub。
     * <p>
     * 镜像 Milvus IT 的 StubEmbeddingModel 约定,生产环境由 atlas-richie-ai 的
    ...
    /**
     * RerankModel 占位 — atlas-richie-ai 的 {@code RerankServiceImpl} 是 {@code @Service},
     * 通过 {@code cn.richie696.component.vector} 包扫描自动注册,IT 上下文里需要提供一个非 null Bean
