...
class DashVectorStoreManagedVectorServiceTest {

    @Test
    void removesCoreCompatibilityContentMetadataBeforeDelegatingToDashVectorStore() {
        CapturingVectorStore store = new CapturingVectorStore();
        DashVectorStoreManagedVectorService service = new DashVectorStoreManagedVectorService(
                null, store, null, Map.of("documents", "dash-documents"));
