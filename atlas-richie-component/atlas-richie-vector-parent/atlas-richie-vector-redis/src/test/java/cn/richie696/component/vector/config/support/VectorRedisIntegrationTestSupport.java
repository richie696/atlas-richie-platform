...
public final class VectorRedisIntegrationTestSupport implements RedisIntegrationTestAccess {
    ...
    private static void appendComponentProperties(List<String> pairs) {
        ...
        // 注意:atlas-richie-ai 的 AiModelAutoConfiguration 在测试环境默认不创建 aiEmbeddingModel
        ...
        // Spring AI RedisVectorStoreAutoConfiguration 强制使用 JedisConnectionFactory,而 atlas-richie-cache
