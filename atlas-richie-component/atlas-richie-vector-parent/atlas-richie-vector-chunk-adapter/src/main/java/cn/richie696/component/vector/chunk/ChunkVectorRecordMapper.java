 ...
 *
 * <p>它位于两个组件的接缝处：上游是 {@code atlas-richie-document-chunking-parent} 产出的
 * 文本切片（{@link Chunk}），下游是 {@code atlas-richie-vector-parent} 接收的向量记录
 ...
 * （在 {@code vector-chunk-adapter} 模块的自动装配中已注册）。</p>
 *
 * @author richie696
 * @version 1.0
 * @since 2025-07-01
