...
本模块构建在 [`desensitize-core`](../atlas-richie-component-desensitize-core/README.zh.md) 之上，是
...
- **Core**：[`README.zh.md`](../atlas-richie-component-desensitize-core/README.zh.md) — 规则、策略、`MaskingService`、
  `DesensitizeUtils`。
- **Logging**：[`README.zh.md`](../atlas-richie-component-desensitize-logging/README.zh.md) — Logback `ConversionRule` /
  TurboFilter。