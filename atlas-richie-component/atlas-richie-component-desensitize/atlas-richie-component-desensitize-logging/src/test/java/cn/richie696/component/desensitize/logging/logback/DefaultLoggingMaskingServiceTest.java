...
class DefaultLoggingMaskingServiceTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(org.springframework.boot.autoconfigure.AutoConfigurations.of(
                    cn.richie696.component.desensitize.core.config.DesensitizeAutoConfiguration.class))
    ...
    void setUp() {
        contextRunner.run(context -> {
            ...
            assertThat(context).hasSingleBean(cn.richie696.component.desensitize.core.service.MaskingService.class);
        });
    }
