...
本模块是 `atlas-richie-component-desensitize` 的 **基础层**，被 `desensitize-jackson`、`desensitize-logging` 引用，业务代码也可直接通过
...
- **Jackson 集成**：[
  `../atlas-richie-component-desensitize-jackson/README.md`](../atlas-richie-component-desensitize-jackson/README.zh.md) —
  `@Sensitive` + Map 序列化，对外接口响应。
- **Logging 集成**：[
  `../atlas-richie-component-desensitize-logging/README.md`](../atlas-richie-component-desensitize-logging/README.zh.md) —
