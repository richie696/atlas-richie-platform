 ...
 */
package cn.richie696.component.desensitize.core.serializer;
...
public class SafeLogSerializer {
    ...
    private String serializeFieldValue(Class<?> declaringClass, Field field, Object fieldValue, MaskScene scene, int depth) {
        if (fieldValue instanceof String str) {
            ...
            if (type != null) {
                return quote(maskingService.mask(str, cn.richie696.component.desensitize.core.model.MaskContext.of(scene, field.getName(), declaringClass), type));
            }
            return quote(str);
        }
