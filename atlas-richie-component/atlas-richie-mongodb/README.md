# Atlas Richie MongoDB Component (atlas-richie-mongodb)

> Unified **MongoDB client** component for Spring Boot 4.x. Provides `MongoTemplate`-based CRUD, multi-source routing,
> **Sentinel** circuit breaker, schema migration, GridFS, and reactive streams. Built on top of
...
| Item                  | Value                                                   |
|-----------------------|---------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-mongodb` |
...
<dependency>
    ...
    <artifactId>atlas-richie-mongodb</artifactId>
</dependency>
```
...
When Sentinel detects N failures / 10s on a Mongo resource, subsequent calls fail fast with `DegradeException`.
Configure via `platform.component.mongodb.circuit-breaker.rules`.
...
- **Microservice (Sentinel)** — [
  `../atlas-richie-microservice/README.md`](../atlas-richie-microservice/README.md)
- **Liquibase** — [`../atlas-richie-liquibase/README.md`](../atlas-richie-liquibase/README.md)
-
