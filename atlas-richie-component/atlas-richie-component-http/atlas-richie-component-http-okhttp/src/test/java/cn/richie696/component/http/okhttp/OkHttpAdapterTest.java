...
import cn.richie696.component.http.okhttp.support.LocalHttpServer;
...
class OkHttpAdapterTest {
    ...
    void asyncAndFutureSupportTypeReference() throws Exception {
        ...
        client.get(server.url("/typed")).async(new cn.richie696.component.http.core.AsyncCallback<Map<String, String>>() {
            @Override
    ...
    void asyncWithClassTypeReturnsBody() throws Exception {
        ...
        client.get(server.url("/async-class")).async(new cn.richie696.component.http.core.AsyncCallback<EchoDto>() {
            @Override
