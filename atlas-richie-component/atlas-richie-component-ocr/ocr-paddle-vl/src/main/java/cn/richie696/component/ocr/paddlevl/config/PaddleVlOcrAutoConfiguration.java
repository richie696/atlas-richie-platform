 ...
 */
package cn.richie696.component.ocr.paddlevl.config;

import cn.richie696.component.http.core.HttpClient;
import cn.richie696.component.ocr.config.OcrProperties;
import cn.richie696.component.ocr.paddlevl.provider.PaddleVlOcrProvider;
 ...
 *   <li>业务侧依赖 {@code ocr-paddle-vl}</li>
 * </ul>
 *
 * @author richie696
 * @version 1.0.0
