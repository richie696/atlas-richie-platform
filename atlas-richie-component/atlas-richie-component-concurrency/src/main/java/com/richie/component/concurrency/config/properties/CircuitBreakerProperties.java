 ...
 *
 * <p>管理本组件提供的 {@link com.richie.component.concurrency.concurrent.CircuitBreaker} 三态熔断器
 * 的注册开关与行为参数。配置示例：</p>
 *
 * <pre>{@code
 * platform:
...
public class CircuitBreakerProperties {
     ...
     * 会创建一个 {@link com.richie.component.concurrency.concurrent.CircuitBreaker} Bean，
     * 供业务方按需注入。</p>
     */
     ...
     * {@link com.richie.component.concurrency.concurrent.CircuitBreaker.Builder} 时会乘以
     * {@code 100} 转为整数百分比。</p>
     */
     ...
     *
     * <p>当前版本底层 {@link com.richie.component.concurrency.concurrent.CircuitBreaker}
