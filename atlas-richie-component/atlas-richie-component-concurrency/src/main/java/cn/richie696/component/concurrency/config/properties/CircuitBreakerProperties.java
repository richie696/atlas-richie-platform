 ...
 */
package cn.richie696.component.concurrency.config.properties;

import cn.richie696.component.concurrency.config.ConcurrencyAutoConfiguration;
import lombok.Data;
...
public class CircuitBreakerProperties {
     ...
     * 会创建一个 {@link cn.richie696.component.concurrency.algorithm.CircuitBreaker} Bean，
     * 供业务方按需注入。</p>
     */
     ...
     * {@link cn.richie696.component.concurrency.algorithm.CircuitBreaker.Builder} 时会乘以
     * {@code 100} 转为整数百分比。</p>
     */
     ...
     *
     * <p>当前版本底层 {@link cn.richie696.component.concurrency.algorithm.CircuitBreaker}
