# Atlas Richie Redis StreamMQ Component (atlas-richie-redis-streammq)
...
`atlas-richie-cache`](../atlas-richie-cache/README.md) Stream MQ code.
...
| Item                  | Value                                                          |
|-----------------------|----------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-redis-streammq` |
