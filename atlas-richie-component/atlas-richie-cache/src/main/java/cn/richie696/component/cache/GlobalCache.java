 ...
 */
package cn.richie696.component.cache;

import cn.richie696.component.cache.ops.*;
...
public class GlobalCache {
     ...
     * <p>轻量 Pub/Sub 发布请用 {@link #notification()}；可靠消息队列请用独立模块 {@code atlas-richie-redis-streammq} 的 {@code StreamMQ}。</p>
     */
