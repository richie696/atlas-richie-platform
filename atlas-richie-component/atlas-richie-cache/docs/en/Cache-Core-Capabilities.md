...
> Code version: atlas-richie-cache
...
> (`atlas-richie-redis-streammq`). See [§22](#22-bounded-queue-queue) / [§23](#23-bounded-stack-stack).
...
`StreamMQ`** (`atlas-richie-redis-streammq`).
...
> `../../../atlas-richie-document-parser/src/main/java/cn/richie696/component/parser/internal/README.md` at the
