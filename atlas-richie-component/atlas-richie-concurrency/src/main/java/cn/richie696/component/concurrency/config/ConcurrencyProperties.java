 ...
 */
package cn.richie696.component.concurrency.config;
 ...
 *
 * <p>本类是 {@code @ConfigurationProperties} 的统一入口，统一前缀 {@code platform.component.concurrency}，
 * 通过三个独立 Properties 类加上行内配置拆分子模块的命名空间：</p>
 *
 * <ul>
 *   <li>{@link RateLimiterProperties} —— 绑定 {@code platform.component.concurrency.rate-limiter.*}</li>
 *   <li>{@link CircuitBreakerProperties} —— 绑定 {@code platform.component.concurrency.circuit-breaker.*}</li>
 *   <li>{@code threadPools} —— 绑定 {@code platform.component.concurrency.thread-pools.*}，管理多个命名
...
public class ConcurrencyProperties {
    ...
    /**
     * 限流器子系统配置 —— {@code platform.component.concurrency.rate-limiter.*}。
     */
    @NestedConfigurationProperty
    private RateLimiterProperties rateLimiter = new RateLimiterProperties();

    /**
     * 熔断器子系统配置 —— {@code platform.component.concurrency.circuit-breaker.*}。
     */
    private CircuitBreakerProperties circuitBreaker = new CircuitBreakerProperties();

    /**
     * 多命名线程池配置 —— {@code platform.component.concurrency.thread-pools.*}。
     *
