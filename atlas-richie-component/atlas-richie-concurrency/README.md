# Atlas Richie Concurrency Component (atlas-richie-concurrency)
...
`atlas-richie-concurrency` is the concurrency utilities component for the Richie platform. Rather than
