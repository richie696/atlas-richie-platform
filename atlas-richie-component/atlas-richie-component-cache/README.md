...
`atlas-richie-component-redis-streammq`](../atlas-richie-component-redis-streammq), with the entry point
...
`atlas-richie-component-redis-streammq`**. This module no longer binds `platform.cache.redis.stream.*` or
...
- Historical
  reference: [docs/Redis-Stream-使用指南.md](../atlas-richie-component-redis-streammq/docs/Redis-Stream-使用指南.md)
...
Stream MQ has been split out into `atlas-richie-component-redis-streammq`. Increase the consumer `concurrency`, optimize
