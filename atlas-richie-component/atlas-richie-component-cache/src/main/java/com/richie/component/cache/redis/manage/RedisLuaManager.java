...
import com.richie.component.cache.function.LuaFunction;
...
public class RedisLuaManager implements LuaFunction {
     ...
     */
    @Override
    public <T> T evalLua(String script, List<String> keys, List<String> args, Class<T> resultType) {
