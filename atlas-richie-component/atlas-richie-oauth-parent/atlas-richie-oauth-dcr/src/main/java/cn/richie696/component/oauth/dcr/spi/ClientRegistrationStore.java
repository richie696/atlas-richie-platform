 ...
 * 动态客户端注册的持久化端口。
 * <p>
 * 把"如何保存/更新/查询已注册的客户端"从 {@link cn.richie696.component.oauth.dcr.DynamicClientRegistrationEndpoint} 中拆出:默认
 * 走 Redis(见 {@link cn.richie696.component.oauth.dcr.support.RedisClientRegistrationStore}),OAuth Service 可替换为带事务的数据库实现,
 * 让 DCR 元数据与业务库在同一事务内提交。
 * </p>
 * <p>
 * 处于 oauth-dcr 的元数据接入位置:由 {@link cn.richie696.component.oauth.dcr.DynamicClientRegistrationEndpoint} 直接调用;写入
