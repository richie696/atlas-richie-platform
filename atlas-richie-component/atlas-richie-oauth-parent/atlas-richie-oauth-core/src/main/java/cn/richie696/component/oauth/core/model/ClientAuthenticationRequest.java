 ...
 * {@link cn.richie696.component.oauth.core.ClientAuthenticationService},新增认证方式(mTLS、JWT assertion 等)不会扩散到协议层。
 * </p>
 * <p>
 * 处于 oauth-core 的协议输入位置:由 HTTP 适配层构造,被 {@link cn.richie696.component.oauth.core.ClientAuthenticationService}
