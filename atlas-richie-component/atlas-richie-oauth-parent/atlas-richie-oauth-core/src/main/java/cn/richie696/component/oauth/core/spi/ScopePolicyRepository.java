 ...
 * <p>
 * 把"接口编码 → 路径/方法/所需 scope"这套映射数据从 {@link cn.richie696.component.oauth.core.ScopeResolver} 中剥离,核心解析器只
 ...
 * </p>
 * <p>
 * 处于 oauth-core 的策略数据接入位置:被 {@link cn.richie696.component.oauth.core.ScopeResolver} 单向调用;反向依赖来自网关拦截器
