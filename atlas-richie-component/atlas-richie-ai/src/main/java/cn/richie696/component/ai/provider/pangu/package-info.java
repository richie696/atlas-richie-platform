 ...
 * (cn.richie696.component.ai.service / model / config)并列存在,未来按 R-N-DESIGN.md §4
 ...
 *       鉴权 {@code X-Apig-AppCode}(与本包语音端共用 {@link AppCodeSigner}),
 *       请求使用 {@code top_k} 字段命名而非 {@code top_n}</li>
 * </ul>
 *
 * <p>华为云独立语音服务(SIS)在 {@code cn.richie696.component.ai.huawei.sis} 包。
 *
 * <h2>状态</h2>
 * <ul>
