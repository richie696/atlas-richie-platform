 ...
 * <ul>
 *   <li>{@link BearerStsSigner} — DashScope / Zhipu / Hunyuan-TokenHub / MiniMax</li>
 *   <li>{@link Tc3StsSigner} — 腾讯云 TC3-HMAC-SHA256 (Hunyuan TTS 1073 / STT 1093)</li>
 *   <li>{@link AppCodeStsSigner} — 阿里 APIG / 华为 APIG (Pangu / 华为 SIS)</li>
 *   <li>{@link AkSkHmacStsSigner} — 火山引擎 OpenAPI 签名 (Doubao VikingDB)</li>
 *   <li>{@link XApiKeyStsSigner} — Doubao openspeech (X-Api-Key + X-Api-Resource-Id)</li>
 * </ul>
 *
 * <h2>线程安全</h2>
