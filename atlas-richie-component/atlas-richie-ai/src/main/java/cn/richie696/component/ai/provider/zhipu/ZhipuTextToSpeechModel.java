...
public class ZhipuTextToSpeechModel implements TextToSpeechModel {
    ...
    /**
     * 容器入口构造器（{@code config.cn.richie696.component.ai.AiModelAutoConfiguration#aiZhipuTtsModel}
    ...
    private HttpClient resolveHttpClient() {
        ...
        if (resolved == null) {
            throw new IllegalStateException(
                    "HttpClient bean not found; please import one of atlas-richie-http-parent-{okhttp|httpclient5|jdk|restclient}");
        }
        return resolved;
    }
