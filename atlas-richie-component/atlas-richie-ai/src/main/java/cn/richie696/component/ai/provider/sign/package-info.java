 ...
 *
 * <p>本包属于 atlas-richie-ai 的多模态能力(R-N)实现,与 Chat 时代的老代码
 * (cn.richie696.component.ai.service / model / config)并列存在。纯 JDK crypto,无第三方 SDK 引入。
 *
 * <h2>签名器</h2>
 * <ul>
 *   <li>{@code cn.richie696.component.ai.support.sign.Tc3Signer} — 腾讯云 TC3-HMAC-SHA256
 *       (用于 Hunyuan 独立产品 1073 TTS / 1093 STT)</li>
 *   <li>{@code cn.richie696.component.ai.support.sign.Aws4Signer} — AWS4 风格 HMAC
 *       (用于部分华为云 SIS 端点的请求级签名)</li>
 *   <li>{@code cn.richie696.component.ai.support.sign.AppCodeSigner} — 华为云 Apig-AppCode
 ...
 */
package cn.richie696.component.ai.provider.sign;