 ...
 *       建议继续走 {@link BailianImageEmbeddingAdapter#embedImage(String)}。</li>
 * </ul>
 *
...
public class TeiImageEmbeddingAdapter implements ImageEmbeddingModel {
     ...
     * 构造适配器。
     *
     * @param httpClient 共享 HTTP 客户端(由 atlas-richie-http-parent-* 提供)
     ...
     * {@link BailianImageEmbeddingAdapter}
