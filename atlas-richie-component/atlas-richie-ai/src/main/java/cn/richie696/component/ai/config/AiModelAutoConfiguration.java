...
import cn.richie696.component.ai.provider.hunyuan.HunyuanStreamingAsrVoiceChatModel;
...
@Slf4j
@Configuration
@ComponentScan("cn.richie696.component.ai")
...
public class AiModelAutoConfiguration {
     ...
     * {@code cn.richie696.component.web.core.reload.HotReloadCloudBridge}。
