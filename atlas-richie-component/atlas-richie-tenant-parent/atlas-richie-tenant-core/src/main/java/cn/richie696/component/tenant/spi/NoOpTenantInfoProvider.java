 ...
 */
package cn.richie696.component.tenant.spi;
 ...
 *
 * <p>判定方法：通过 {@link cn.richie696.component.tenant.healthcheck.TenantHealthIndicator}
 * （启用 {@code platform.tenant.health-check.enabled=true}）启动期检查当前 Bean 仍是本类则拒绝启动。</p>
 *
 * @author richie696
 * @since 2.0
 */
