...
public class TenantExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDataSourceUnavailable(
        ...
        return buildResponse(HttpStatus.SERVICE_UNAVAILABLE, "TENANT_DATA_SOURCE_UNAVAILABLE", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleTenantMigrating(
        ...
        return buildResponse(HttpStatus.SERVICE_UNAVAILABLE, "TENANT_MIGRATING", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleTenantSwitchInTx(
        ...
        return buildResponse(HttpStatus.FORBIDDEN, "TENANT_SWITCH_IN_TRANSACTION", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleTenantNotFound(
        ...
        return buildResponse(HttpStatus.NOT_FOUND, "TENANT_NOT_FOUND", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleModeMigration(
        ...
        return buildResponse(HttpStatus.FORBIDDEN, "TENANT_MODE_MIGRATION_DENIED", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleProvision(
        ...
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "TENANT_PROVISION_FAILED", e.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleBusiness(
        ...
        return buildResponse(HttpStatus.OK, e.getCode(), e.getMessage());
    }
