# Atlas Richie MFA Component (atlas-richie-mfa-parent)
...
| Item                  | Value                                                                                                              |
|-----------------------|--------------------------------------------------------------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-mfa-parent`                                                                |
| **Category**          | Identity & access — multi-factor authentication                                                                    |
| **Hard dependencies** | `atlas-richie-context`, `atlas-richie-cache` (read-only for validation), Liquibase + DB (for management) |
...
| SMS / email second-factor channels                                      | An OAuth server (combine with `atlas-richie-oauth-parent`)       |
...
```
atlas-richie-mfa-parent        (parent POM)
...
- **OAuth integration** — [`../atlas-richie-oauth-parent/README.md`](../atlas-richie-oauth-parent/README.md)
- **Tenant component** — [`../atlas-richie-tenant-parent/README.md`](../atlas-richie-tenant-parent/README.md)
