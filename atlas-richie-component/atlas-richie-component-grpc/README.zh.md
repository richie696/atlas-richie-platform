...
| 项 | 值 | ---| ---| **坐标**
`cn.richie696.component:atlas-richie-component-grpc` | **类别** | 横切基础设施——gRPC 拦截器栈 | **JDK / Spring Boot** |
...
`atlas-richie-component-microservice` 的规则管理模式。
...
仅做执行，规则加载由业务方负责 | 结合 `atlas-richie-component-microservice` 使用 | **无客户端负载均衡策略** | Channel
