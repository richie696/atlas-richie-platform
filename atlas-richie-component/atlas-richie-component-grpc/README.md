...
| Item | Value | ------| -------| **Artifact**
`cn.richie696.component:atlas-richie-component-grpc` | **Category** | Cross-cutting infrastructure — gRPC interceptor
...
`atlas-richie-component-microservice`](../atlas-richie-component-microservice/README.md) for rule management patterns.
...
via Sentinel APIs | Combine with `atlas-richie-component-microservice` for rule management. | **No client-side
...
- **Sentinel flow control** — [`atlas-richie-component-microservice`](../atlas-richie-component-microservice/README.md)
