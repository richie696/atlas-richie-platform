# Atlas Richie Desensitize Core (desensitize-core)
...
This is the **foundation layer** of `atlas-richie-desensitize-parent`. It is consumed by the `desensitize-jackson`
...
(`desensitize-core` is automatically registered with Spring Boot auto-configuration through
