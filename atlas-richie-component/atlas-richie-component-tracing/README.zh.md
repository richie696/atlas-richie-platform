...
，写入 `X-Trace-Id` 响应头 + SLF4J MDC。与 `atlas-richie-component-logging` 配合后，日志中自动出现 `trace_id` 用于检索。
...
- **Web-Core Trace 透传** — [`../atlas-richie-component-web/README.zh.md`](../atlas-richie-component-web/README.zh.md)
  §3
