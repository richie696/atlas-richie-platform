...
class QdRantVectorServiceImplTest {
    ...
    void createIndex_usesHnswConfig() throws Exception {
        ...
        cn.richie696.component.vector.config.VectorProperties.IndexConfig config =
                new cn.richie696.component.vector.config.VectorProperties.IndexConfig();
    ...
    void createIndex_mapsMetricToCorrectDistance() throws Exception {
        ...
        var l2Config = new cn.richie696.component.vector.config.VectorProperties.IndexConfig();
        l2Config.setDimension(768);
        l2Config.setMetric("l2");
        service.createIndex("c-l2", l2Config);

        // metric=dot → Distance.Dot
        var dotConfig = new cn.richie696.component.vector.config.VectorProperties.IndexConfig();
    ...
    void createIndex_defaultsDimensionAndMetric() throws Exception {
        ...
        var cfg = new cn.richie696.component.vector.config.VectorProperties.IndexConfig();
