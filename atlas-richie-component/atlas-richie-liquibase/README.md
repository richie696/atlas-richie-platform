# Atlas Richie Liquibase Component (atlas-richie-liquibase)
...
| Item                  | Value                                                        |
|-----------------------|--------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-liquibase`    |
...
- **DAO** — [`../atlas-richie-dao/README.md`](../atlas-richie-dao/README.md)
-
