# Atlas Richie Liquibase组件 (atlas-richie-liquibase)
...
| 项         | 值                                                              |
|------------|-----------------------------------------------------------------|
| **坐标**   | `cn.richie696.component:atlas-richie-liquibase`       |
| **类别**   | 数据库——schema 迁移                                             |
...
- **DAO** — [`./atlas-richie-dao/README.zh.md`](./atlas-richie-dao/README.zh.md)
-
