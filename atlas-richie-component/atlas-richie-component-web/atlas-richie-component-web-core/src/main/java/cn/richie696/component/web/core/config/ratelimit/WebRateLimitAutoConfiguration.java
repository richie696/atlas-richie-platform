...
import cn.richie696.component.concurrency.registry.DefaultRateLimiterRegistry;
...
import cn.richie696.component.web.core.interceptor.RateLimitInterceptor;
 ...
 * {@link cn.richie696.component.web.core.servlet.InterceptingFilter} 通过
...
@Slf4j
@AutoConfiguration
@org.springframework.boot.autoconfigure.AutoConfigureAfter(cn.richie696.component.web.core.config.ratelimit.WebKeyResolverAutoConfiguration.class)
