...
`atlas-richie-component-concurrency` and are **not** redefined in web-core. `DegradeStrategyRegistry` stays in web-core
...
**Implementation strategy**: **reuse `atlas-richie-component-concurrency:RateLimiter`**, do not write a TokenBucket
...
**Implementation strategy**: **reuse `atlas-richie-component-concurrency:CircuitBreaker`**, do not write your own state
...
- ❌ **Does not** provide fine-grained events "before / after controller invocation" — that is the domain of AOP aspects
  (use `atlas-richie-component-logging`).
...
- **Dependencies & collaborating platform components**:
    ...
    - [`atlas-richie-component-oauth`](../atlas-richie-component-oauth/README.zh.md) — authentication / authorization
    ...
    - [`atlas-richie-component-i18n`](../atlas-richie-component-i18n/README.zh.md) — internationalization resource
      files.
    - [`atlas-richie-component-microservice`](../atlas-richie-component-microservice/README.zh.md) — Sentinel /
      OpenFeign (rate limit / circuit breaker complements at the RPC layer).
    - [`atlas-richie-component-logging`](../atlas-richie-component-logging/README.zh.md) — Service / Controller
