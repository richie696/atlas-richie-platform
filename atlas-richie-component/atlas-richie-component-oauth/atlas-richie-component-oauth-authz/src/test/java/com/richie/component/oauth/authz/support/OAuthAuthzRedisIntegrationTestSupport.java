...
public final class OAuthAuthzRedisIntegrationTestSupport implements RedisIntegrationTestAccess {
    ...
    private static final GenericRedisIntegrationTestSupport DELEGATE = GenericRedisIntegrationTestSupport.create(
            ...
            OAuthAuthzRedisIntegrationTestSupport::appendComponentProperties,
            "OAUTH");

    private OAuthAuthzRedisIntegrationTestSupport() {
    }

    private static final OAuthAuthzRedisIntegrationTestSupport INSTANCE = new OAuthAuthzRedisIntegrationTestSupport();

    public static OAuthAuthzRedisIntegrationTestSupport getInstance() {
        return INSTANCE;
    }
    ...
    private static void appendComponentProperties(List<String> pairs) {
        ...
        pairs.add("platform.component.oauth.token-secret=it-test-secret-key-for-oauth-authz-integration-test");
    }
}
