# Atlas Richie i18n Component (atlas-richie-i18n)
...
| Item                  | Value                                                      |
|-----------------------|------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-i18n`       |
...
<dependency>
    ...
    <artifactId>atlas-richie-i18n</artifactId>
</dependency>
```
...
Yes — see [
`atlas-richie-web-parent` §2 Global exception handling](../atlas-richie-web-parent/README.md#2-global-exception-handling).

## 📚 Further Reading

- **Parent component** — [`../README.md`](../README.md) / [`../README.zh.md`](../README.md)
- **Web (consumes i18n)** — [`../atlas-richie-web-parent/README.md`](../atlas-richie-web-parent/README.md)
-
