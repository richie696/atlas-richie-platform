# Atlas Richie Messaging Component (atlas-richie-messaging-parent)
...
| Item                  | Value                                                                  |
|-----------------------|------------------------------------------------------------------------|
| **Artifact**          | `cn.richie696.component:atlas-richie-messaging-parent` (parent POM) |
...
```
atlas-richie-messaging-parent                    ← parent POM
...
- **State machine (uses messaging)** — [
  `../atlas-richie-statemachine/README.md`](../atlas-richie-statemachine/README.md)
