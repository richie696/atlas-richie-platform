...
import cn.richie696.component.tenant.spi.NoOpTenantInfoProvider;
 ...
 * </ol>
 *
 * <p><b>默认关闭</b>({@code platform.tenant.health-check.enabled=false})。
...
@Component
@Order(0)
@ConditionalOnProperty(prefix = MultiTenancyProperties.PREFIX + ".health-check", name = "enabled", havingValue = "true")
