 ...
 * （{@code ^[A-Za-z_][A-Za-z0-9_]*$}，1-128 字符），不合法时抛 {@link cn.richie696.component.tenant.exception.TenantErrorCode#TENANT_INVALID_NAMING}。</p>
 *
 * @author richie696
 * @since 2.0
 */
public class DatabaseStrategy extends AbstractTenancyStrategy {
     ...
     * @throws cn.richie696.component.tenant.exception.BusinessException 租户未绑定 / tenantId 非法 / dataSourceKey 不符合命名规范时
     */
    @Override
