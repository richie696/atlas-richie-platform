 ...
 */
package cn.richie696.component.tenant.circuit;
...
public class DataSourceHealthProbe {
    ...
    /**
     * 定时探测所有数据源。间隔由 {@code platform.tenant.health.probe-interval-ms} 控制（默认 30s）。
     */
    @Scheduled(fixedDelayString = "${platform.tenant.health.probe-interval-ms:30000}")
