 ...
 */
package cn.richie696.component.tenant.monitor;

import cn.richie696.component.tenant.circuit.DataSourceCircuitBreaker;
import cn.richie696.component.tenant.circuit.DataSourceCircuitBreaker.CircuitStatus;
...
public class TenantMeterBinder implements MeterBinder {
    ...
    public void bindTo(MeterRegistry registry) {
        if (metricsCollector == null) {
            log.warn("TenantMetricsCollector not available — monitoring disabled (platform.tenant.monitor.enabled=false), skipping metric registration");
            return;
        }
