...
public class MultiTenancyProperties {
    ...
    /**
     * 租户信息缓存配置（{@link cn.richie696.component.tenant.spi.CachingTenantInfoProvider}）。
     *
    ...
    /**
     * 启动期 SPI 健康检查配置（{@link cn.richie696.component.tenant.healthcheck.TenantHealthIndicator}）。
     *
    ...
    public static class TenantInfoCacheConfig {
        /**
         * 是否启用 {@link cn.richie696.component.tenant.spi.CachingTenantInfoProvider} 装饰器。
    ...
    public static class HealthCheckConfig {
        /**
         * 是否启用 {@link cn.richie696.component.tenant.healthcheck.TenantHealthIndicator}。
         * 启用后若 {@link cn.richie696.component.tenant.spi.TenantInfoProvider} 仍是 NoOp 占位，
    ...
    public static class StartupValidationConfig {
        /**
         * 是否启用 {@link cn.richie696.component.tenant.healthcheck.StartupSchemaValidator}。
