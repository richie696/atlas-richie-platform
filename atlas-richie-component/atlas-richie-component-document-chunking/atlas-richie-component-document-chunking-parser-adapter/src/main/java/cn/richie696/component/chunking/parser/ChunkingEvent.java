...
interface ChunkingEvent permits ChunkingEvent.Section, ChunkingEvent.Finished, ChunkingEvent.Failed {
    /**
     ...
     */
    record Section(ChunkedSection value) implements
     ...
     */
    record Finished(ReadSummary summary, int totalSections, int emittedChunks) implements
     ...
     */
    record Failed(Throwable error) implements
