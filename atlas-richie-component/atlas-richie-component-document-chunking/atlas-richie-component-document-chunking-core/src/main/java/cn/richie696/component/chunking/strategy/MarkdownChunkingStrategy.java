...
public final class MarkdownChunkingStrategy extends AbstractCharacterChunkingStrategy {
    ...
    MarkdownChunkingStrategy(ChunkingStrategySupport support) { super(support); }
    @Override public ChunkingRule.Strategy type() { return ChunkingRule.Strategy.MARKDOWN; }
