...
public final class FixedChunkingStrategy extends AbstractCharacterChunkingStrategy {
    FixedChunkingStrategy(ChunkingStrategySupport support) { super(support); }
    @Override public ChunkingRule.Strategy type() { return ChunkingRule.Strategy.FIXED; }
    ...
    @Override protected boolean reportsMissingBoundary() { return false; }
}
