...
public final class SentenceChunkingStrategy extends AbstractCharacterChunkingStrategy {
    ...
    SentenceChunkingStrategy(ChunkingStrategySupport support) { super(support); }
    @Override public ChunkingRule.Strategy type() { return ChunkingRule.Strategy.SENTENCE; }
