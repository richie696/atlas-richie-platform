 ...
 */
package cn.richie696.component.ocr.volcano.config;

import cn.richie696.component.http.core.HttpClient;
import cn.richie696.component.ocr.config.OcrProperties;
import cn.richie696.component.ocr.volcano.provider.VolcanoOcrProvider;
 ...
 *   <li>业务侧依赖 {@code ocr-volcano} —— 把本类带到 classpath</li>
 * </ul>
 *
 * <p><b>装配流程</b>:
 * <ol>
