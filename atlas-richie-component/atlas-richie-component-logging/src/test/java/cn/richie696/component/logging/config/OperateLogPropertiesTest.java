 ...
 */
package cn.richie696.component.logging.config;

import cn.richie696.component.logging.enums.RecordTypeEnum;
...
class OperateLogPropertiesTest {
    ...
    void setters_updateValues() {
        ...
        properties.setRecordType(cn.richie696.component.logging.enums.RecordTypeEnum.REDIS);
        properties.setMqTopicName("custom-topic");
        properties.setCacheAccessLogKey("custom:key");

        assertThat(properties.isEnable()).isFalse();
        assertThat(properties.getRecordType()).isEqualTo(cn.richie696.component.logging.enums.RecordTypeEnum.REDIS);
