...
public final class IBMKeyProtectSecretBootstrapProviderFactory extends AbstractRemoteProviderFactory {
    @Override protected String type() { return "ibm-key-protect"; }
    @Override protected String prefix() { return "platform.component.secret.ibm-key-protect"; }
