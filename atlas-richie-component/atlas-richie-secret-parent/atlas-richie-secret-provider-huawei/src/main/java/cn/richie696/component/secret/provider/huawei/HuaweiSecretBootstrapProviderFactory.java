...
public final class HuaweiSecretBootstrapProviderFactory extends AbstractRemoteProviderFactory {
    @Override protected String type() { return "huawei"; }
    @Override protected String prefix() { return "platform.component.secret.huawei"; }
