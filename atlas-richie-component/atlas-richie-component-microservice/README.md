...
- ✅ **Sentinel first** — fail fast on dead hosts; integrates with [
  `atlas-richie-component-mongodb`](../atlas-richie-component-mongodb/README.md) and [
  `atlas-richie-component-http`](../atlas-richie-component-http/README.md).
...
- **HTTP client (used by Feign)** — [
  `../atlas-richie-component-http/README.md`](../atlas-richie-component-http/README.md)
